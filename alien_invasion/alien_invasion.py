...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Updates position of bullets and get rif of old bullets"""
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to bullets-aliens collision"""
    ...
    def _update_aliens(self):
        ...
        # Look for aliens hit bottom of the screen
    ...
    def _create_alien(self, x_position, y_position):
        """Creates an alien and place it in the fleet"""
    ...
    def _update_screen(self):
        """Update images on the screem and flip to next screen"""
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                # Treat it the same if the ship was hit
                self._ship_hit()
                break
